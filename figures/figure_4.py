import os
from dispatch import Dispatch	# general case
a_val = 1
c_val = 1
SoC   = 1 				# q0, preferred SoC
Q0_val  = SoC
test = Dispatch(T=1,a=a_val,c=c_val,Q0=SoC,dQ0=0,QT=None,dQT=None,S=SoC)	# adjust dQ0
...
# test = Dispatch(T=1,a=a_val,c=c_val,Q0=SoC,dQ0=0,QT=0,dQT=None,S=None)			# note QT -> 0.5
